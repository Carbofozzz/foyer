...
- 2026-09-11: Company house write-up [`docs/ORG.md`](docs/ORG.md). Wizard does not switch personal/org. Org direction: admins (optional split rights), employee chats, corp hooks; Foyer login is not for every desk.
