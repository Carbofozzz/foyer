...
- 2026-09-13: Org 2 — `agents.system_prompt` is the paste-as-is prompt (recommended MCP text prefilled). No stacked “Foyer lines”. Prompt is not a court argument; ranks belong in the charter (Org 6). `PATCH /api/cabinet/:token/connect`. OpenAPI `0.44.0`.
