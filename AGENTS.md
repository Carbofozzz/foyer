...
- 2026-09-13: [`docs/ORG.md`](docs/ORG.md) implementation plan Org 1–8 (second principal → prompt → contacts → decide links → rights → court metadata → route fights → paid create). Additive only.
