...
4. A product guardian is a connected assistant that reads the constitution. Phrase-matching clients in `agents/` are test-only — label them. Spawn is a throwaway house. Gateway code never objects for anyone.
